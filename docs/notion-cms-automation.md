...
4. Check `Published` when the post is ready. Notion immediately calculates `Status` as `Live`; the publish-sync automation assigns `Publication Date` once and refreshes public blog/RSS data.
